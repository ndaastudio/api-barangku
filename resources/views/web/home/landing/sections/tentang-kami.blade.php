...
<section id="tentangKami" class="section-py landing-features">
	<div class="container">
		...
		<h3 class="text-center mb-1">
			<span class="section-title">Barangku</span> merupakan aplikasi pencatatan barang
		</h3>
		...
		<div class="features-icon-wrapper row gx-0 gy-4 g-sm-5">
			<div class="col-lg-4 col-sm-6 text-center features-icon-box">
				<div class="text-center mb-3">
					<img src="{{ asset('vuexy/assets/img/front-pages/icons/laptop.png') }}" alt="laptop charging" />
				</div>
			...
			<div class="col-lg-4 col-sm-6 text-center features-icon-box">
				<div class="text-center mb-3">
					<img src="{{ asset('vuexy/assets/img/front-pages/icons/rocket.png') }}" alt="transition up" />
				</div>
			...
			<div class="col-lg-4 col-sm-6 text-center features-icon-box">
				<div class="text-center mb-3">
					<img src="{{ asset('vuexy/assets/img/front-pages/icons/user.png') }}" alt="lifebelt" />
				</div>
