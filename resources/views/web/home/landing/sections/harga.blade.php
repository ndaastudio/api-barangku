		...
		{{-- <div class="text-center mb-5">
			<div class="position-relative d-inline-block pt-3 pt-md-0">
				...
				<div class="pricing-plans-item position-absolute d-flex">
					<img src="{{ asset('vuexy/assets/img/front-pages/icons/pricing-plans-arrow.png') }}" alt="pricing plans arrow"
						class="scaleX-n1-rtl" />
		...
		<div class="row gy-4 pt-lg-3">
				...
				<div class="card">
					<div class="card-header">
						<div class="text-center">
							<img src="{{ asset('vuexy/assets/img/front-pages/icons/paper-airplane.png') }}" alt="paper airplane icon"
								class="mb-4 pb-2" />
			...
			{{-- <div class="col-xl-4 col-lg-6">
				<div class="card">
					<div class="card-header">
						<div class="text-center">
							<img src="{{ asset('vuexy/assets/img/front-pages/icons/shuttle-rocket.png') }}" alt="shuttle rocket icon"
								class="mb-4 pb-2" />
		...
		<div class="row gy-3">
			<div class="col-sm-6 col-lg-3">
				<div class="card border border-label-primary shadow-none">
					<div class="card-body text-center">
						<img src="{{ asset('vuexy/assets/img/front-pages/icons/laptop.png') }}" alt="laptop" class="mb-2" />
			...
			<div class="col-sm-6 col-lg-3">
				<div class="card border border-label-success shadow-none">
					<div class="card-body text-center">
						<img src="{{ asset('vuexy/assets/img/front-pages/icons/user-success.png') }}" alt="laptop" class="mb-2" />
			...
			<div class="col-sm-6 col-lg-3">
				<div class="card border border-label-info shadow-none">
					<div class="card-body text-center">
						<img src="{{ asset('vuexy/assets/img/front-pages/icons/diamond-info.png') }}" alt="laptop" class="mb-2" />
			...
			<div class="col-sm-6 col-lg-3">
				<div class="card border border-label-warning shadow-none">
					<div class="card-body text-center">
						<img src="{{ asset('vuexy/assets/img/front-pages/icons/check-warning.png') }}" alt="laptop" class="mb-2" />
