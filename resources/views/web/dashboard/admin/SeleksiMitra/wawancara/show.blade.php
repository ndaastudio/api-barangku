		...
		<div class="row">
			<div class="col-xs-12 col-lg-6">
				...
				<form action="{{ route('seleksi-mitra.wawancara.id', ['id' => $mitra->id]) }}" method="POST">
					@csrf
					@method('PUT')
					<button type="submit" class="btn btn-success my-3"><i class="menu-icon tf-icons ti ti-thumb-up"></i>Lolos
						Seleksi</button>
				</form>
			</div>
			<div class="col-xs-12 col-lg-6">
				<iframe style="height: 80vh" src="{{ asset('storage/' . $mitra->dokumen_cv) }}" frameBorder="0" scrolling="auto"
					width="100%"></iframe>
			</div>
		</div>
	</div>
