							...
							<td class="text-center">
								<div class="row">
									<div class="col-auto mt-2 mb-2">
										<form action="{{ route('pembayaran-mitra.menunggu.tolak.id', ['id' => $pembayaran->id]) }}" method="POST">
											@csrf
											@method('PUT')
											<button type="submit" class="btn btn-danger" data-bs-toggle="tooltip" data-bs-placement="bottom"
												data-bs-title="Tolak"><i class="fa-solid fa-x"></i></button>
										</form>
									</div>
									<div class="col-auto mt-2 mb-2">
										<form action="{{ route('pembayaran-mitra.menunggu.terima.id', ['id' => $pembayaran->id]) }}" method="POST">
											@csrf
											@method('PUT')
											<button type="submit" class="btn btn-success" data-bs-toggle="tooltip" data-bs-placement="bottom"
												data-bs-title="Terima"><i class="fa-solid fa-check"></i></button>
										</form>
									</div>
								</div>
							</td>
