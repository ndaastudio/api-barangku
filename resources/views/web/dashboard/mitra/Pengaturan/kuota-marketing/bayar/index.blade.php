								...
								<div class="row">
									...
									@if ($pembayaran->tanggal_transfer !== null && ($pembayaran->status === 0 || $pembayaran->status === 2))
										<div class="col-auto mt-2 mb-2">
											<a
												href="https://api.whatsapp.com/send?phone={{ substr_replace('081367676651', '62', 0, 1) }}&text={{ urlencode("Halo admin, Saya sudah melakukan pembayaran. Mohon diterima pembayaran saya, berikut ini rincian pembayaran saya:\n\nJenis Paket:\n*{$jenisPaket}*\nKode Pembayaran:\n*{$kodePembayaran}*\nTotal Pembayaran:\n*Rp {$totalPembayaran}*\nNomor Rekening:\n*{$nomorRekening}*\nNama Pemilik Rekening:\n*{$namaRekening}*\nBank:\n*{$namaBank}*\n\nSekian konfirmasi dari saya, besar harapan untuk diterima pembayaran saya. Terima kasih.") }}"
