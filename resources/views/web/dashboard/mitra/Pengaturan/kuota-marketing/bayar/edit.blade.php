				...
				<div class="row">
					<div class="col-md-6">
						<div class="mb-3">
							...
							<input name="nama_rekening" type="text"
								...
								placeholder="Contoh: Budi" value="{{ old('nama_rekening', $pembayaran->mitra->nama_rekening) }}">
					...
					<div class="col-md-6">
						<div class="mb-3">
							...
							<input name="nama_bank" type="text" class="form-control {{ $errors->has('nama_bank') ? 'is-invalid' : '' }}"
								id="nama_bank" placeholder="Contoh: BNI" value="{{ old('nama_bank', $pembayaran->mitra->nama_bank) }}">
					...
					<div class="col-md-6">
						<div class="mb-3">
							...
							<input name="nomor_rekening" type="number"
								...
								placeholder="Contoh: 1234567890" value="{{ old('nomor_rekening', $pembayaran->mitra->nomor_rekening) }}">
					...
					<div class="col-md-6">
						<div class="mb-3">
							...
							<input type="date" class="form-control {{ $errors->has('tanggal_transfer') ? 'is-invalid' : '' }}"
								id="tanggal_transfer" name="tanggal_transfer" value="{{ old('tanggal_transfer') }}">
							@if ($errors->has('tanggal_transfer'))
								<div class="invalid-feedback">{{ $errors->first('tanggal_transfer') }}</div>
							@endif
						</div>
					</div>
					<div class="col-md-12">
